...
import 'package:activities/presentacion/widgets/equipo_actividad_item.dart';
import 'package:flutter/material.dart';
import 'package:activities/configuracion/tema/app_tema.dart';
import 'package:activities/presentacion/pantallas/creacion/crear_actividad_equipo.dart';

class MisEquiposAcividades extends StatelessWidget{
  const MisEquiposAcividades({super.key});
          ...
          children: [
            BotonFlotante(
              ...
              onPressed: (){
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context)=>const CrearActividadEquipo()));
              },),
            const SizedBox(
              height:10
            ),
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index){
                  ...
                  return const EquipoActividadItem();
                }
              )
            ),
