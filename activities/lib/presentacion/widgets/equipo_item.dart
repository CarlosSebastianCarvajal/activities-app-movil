import 'package:activities/presentacion/pantallas/listas/mis_equipos_actividades.dart';
import 'package:flutter/material.dart';

class EquipoItem extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    return GestureDetector(
      onTap: () { 
        Navigator.push(context, MaterialPageRoute(builder: (context)=>const MisEquiposAcividades()));
      },
      child: Column(
        children: [
          Container(
