import 'package:activities/presentacion/pantallas/detalle_culminar/detalle_cumplimiento_actividad_equipo.dart';
import 'package:flutter/material.dart';

class CumplimientoEquipoActividadItem extends StatelessWidget{

  const CumplimientoEquipoActividadItem({
    super.key,
  });
  ...
  Widget build(BuildContext context){
    return GestureDetector(
      onTap: () { 
        Navigator.push(context, MaterialPageRoute(builder: (context)=>const DetalleCumplimientoActividadEquipo()));
      },
      child: Column(
        children: [
          Container(
